 ...
 * 音频播放器实现文件
 * @version  1.0
 * @author   Itachi(forwk1990@gmail.com)
 * ------------------------------------------
 */
var f = function () {
    var _ = NEJ.P,
     ...
     * @config  {String|Node} connectedPlayElement 与外部连接的播放元素
     */
    ...
    _pro.__reset = function (_options) {
        ...
        // 链接外部播放元素
        this.__connectedPlayElement = _options.connectedPlayElement || null;
        if(!!this.__connectedPlayElement){
            _v._$addEvent(this.__connectedPlayElement,'click',() => this.__onPlay(),false);
        }
